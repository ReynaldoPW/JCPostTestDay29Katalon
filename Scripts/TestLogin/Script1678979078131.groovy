...
WebUI.setText(findTestObject('Object Repository/Login/Page_My Account  ToolsQA Demo Site/input__username'), 'reypau')

WebUI.setEncryptedText(findTestObject('Object Repository/Login/Page_My Account  ToolsQA Demo Site/input__password'), '/DC12iZoLA7LhSNf8IZ3NA==')

WebUI.click(findTestObject('Object Repository/Login/Page_My Account  ToolsQA Demo Site/button_Log in'))

WebUI.verifyElementText(findTestObject('Object Repository/Login/Page_My Account  ToolsQA Demo Site/strong_reypau'), 'reypau')
